-- Fix the ambiguous column reference in delete_ticket function
DROP FUNCTION IF EXISTS public.delete_ticket(uuid);
...
BEGIN
  ...
  DELETE FROM public.ticket_comments WHERE ticket_id = p_ticket_id;
