-- First, let's create new roles that map to Freshdesk style
-- We'll add new enum values to the existing type rather than recreating it
...
-- Update existing user roles to use Freshdesk-style naming
